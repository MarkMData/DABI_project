...
# tot trans vs ave amount
ggplot(complete_df, aes(x = tot_trans, y = ave_amount, color = Cluster4)) +
  geom_point(alpha = 0.6,position = "jitter") +
  theme_minimal() +
  labs(x = "tot_trans", y = "ave_amount") +
  scale_fill_manual(values=clust_colmap4)
# tot trans vs max amount
ggplot(complete_df, aes(x = tot_trans, y = max_amount, color = Cluster4)) +
  geom_point(alpha = 0.6,position = "jitter") +
  theme_minimal() +
  labs(x = "tot_trans", y = "max_amount") +
  scale_fill_manual(values=clust_colmap4)
# tot trans vs tot amount
ggplot(complete_df, aes(x = tot_trans, y = tot_amount, color = Cluster4)) +
  geom_point(alpha = 0.6,position = "jitter") +
  theme_minimal() +
  labs(x = "tot_trans", y = "tot_amount") +
  scale_fill_manual(values=clust_colmap4)
